...
Выпущен, проверен частично. Обслуживание PHP подтверждено на настоящей Windows.
Две вещи — нет: привязка к порту 80 без прав администратора и выживание при
закрытии консоли или IDE. Обе названы в разделе
