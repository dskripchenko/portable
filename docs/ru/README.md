...
панель и замена себя командой `upgrade` — последнее только с 1.4.2: тесты она
проходила месяцами, ни разу не доработав до конца на живой машине, и дважды до
этого объявлялась починенной. Что там было — в
[примечании в конце README проекта](../../README.md).
